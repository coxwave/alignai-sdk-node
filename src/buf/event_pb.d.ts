...
export declare class Event extends Message<Event> {
   ...
   * feedback_create (Feedback is created. Recommend to send this event to analyze feedback properly.)
   *
...
export declare class EventProperties_MessageProperties extends Message<EventProperties_MessageProperties> {
   ...
   *
   * @generated from field: string message_id_hint = 2 [deprecated = true];
   * @deprecated
   */
...
export declare class EventProperties_UserProperties extends Message<EventProperties_UserProperties> {
  ...
  /**
   * User's display name.
   * Usually, use legal name or nickname of the user. Optional, but recommended to provide.
   *
...
export declare class EventProperties_FeedbackProperties extends Message<EventProperties_FeedbackProperties> {
   ...
   *
   * @generated from field: int32 message_index_hint = 2;
   */
  messageIndexHint: number;
   ...
   *
   * @generated from field: ingestion.v1alpha.EventProperties.FeedbackProperties.Target feedback_target = 3;
   */
   ...
   *
   * Available values: `"thumbs_up"`, `"thumbs_down"`
   *
