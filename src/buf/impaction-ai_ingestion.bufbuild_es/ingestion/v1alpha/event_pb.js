 ...
 *   - feedback_session_create: FeedbackProperties
 *   - feedback_message_create: FeedbackProperties
 *
 * @generated from message ingestion.v1alpha.EventProperties
 */
export const EventProperties = proto3.makeMessageType(
 ...
 */
export const EventProperties_SessionProperties = proto3.makeMessageType(
 ...
 */
export const EventProperties_MessageProperties = proto3.makeMessageType(
 ...
 */
export const EventProperties_MessageProperties_Role = proto3.makeEnum(
 ...
 * If not, this event will be ignored.
 *
 * @generated from message ingestion.v1alpha.EventProperties.UserProperties
 */
export const EventProperties_UserProperties = proto3.makeMessageType(
 ...
 */
export const EventProperties_UserProperties_Location = proto3.makeMessageType(
 ...
 */
export const EventProperties_FeedbackProperties = proto3.makeMessageType(
 ...
 */
export const EventProperties_FeedbackProperties_Target = proto3.makeEnum(
